...
for file in range(0,4):
    ...
    if (file == 0):
        filename = "{}{}{}".format('/gs/scratch/cenoi/deep-belief-network/OracleV5C14-training/',iteration ,'-train-lapd-no.neg')
    # Create the training data (Positive Examples)
    elif (file == 1):
        filename = "{}{}{}".format('/gs/scratch/cenoi/deep-belief-network/OracleV5C14-training/',iteration ,'-train-lapd-yes.pos')

    # Create the testing data (Negative Examples)
    elif (file == 2):
        filename = "{}{}{}".format('/gs/scratch/cenoi/deep-belief-network/OracleV5C14-training/',iteration ,'-test-lapd-no.neg')

    # Create the testing data (Positive Examples)
    else:
        filename = "{}{}{}".format('/gs/scratch/cenoi/deep-belief-network/OracleV5C14-training/',iteration ,'-test-lapd-yes.pos')
...
# Training
classifier = SupervisedDBNClassification(hidden_layers_structure=[2500,2500,2500],
