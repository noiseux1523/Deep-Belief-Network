...
python classification_demo.py --hidden_layers_structure "1000,1000,1000" --learning_rate_rbm 0.01 --learning_rate 0.1 --n_epochs_rbm 100 --n_iter_backprop 1000
